...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        ...
        if (pontos < 0) throw new IllegalArgumentException("Pontos inválidos");
        if (nome == null) throw new NullPointerException("Nome não informado");
        if (habilitacao == null) throw new NullPointerException("Habilitação não informada");
